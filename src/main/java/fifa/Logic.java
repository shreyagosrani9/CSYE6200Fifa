...
public class Logic {
    ...
    private final String winInfos[] = {"It will be kicked...", "Something went wrong...", 
    		"Go practice", "You woke up on the wrong side of the bed", "It's not your day", 
    		"I will soon take revenge", "Do you need coffee", "xD", 
    		"xDDDD", "You're a noob (just kidding)", "They lagged", 
